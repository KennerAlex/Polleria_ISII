    ...
    {{-- <div id="separator-ribbon" class="justify-content-center">
      <div class="content" style="background-color: yellow;"> 
        <div class="row justify-content-center"> --}}
          <h1 style="font-family: serif; font-size: 30pt; font-size-adjust: 1.2 d-no d-md-block ; text-decoration: underline; font-weight: bolder;">Bebidas</h1>
        {{-- </div>    
      </div>
    </div> --}}
   </div>
 
    <form action="{{route('bebidas.create')}}">
      <div class="row">
        <div class="col-10 d-none d-lg-block"></div>
        <div class="col-5 col-sm-2">
          <input type="submit" class="btn btn-warning border-dark" value="Agregar Bebida">
        </div>
      </div><br>
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-columns"> 
              ...
              <div class="row">
                <div class="col-6 " style="justify-content: center" >
                  <div class="card" style="width: 20rem; margin-left: 20px;justify-content: center">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                       ...
                       <div class="col col-sm-6">
                        <form action="{{route('bebidas.edit',$item->id)}}" method="get">
