    ...
    {{-- <div id="separator-ribbon" class="justify-content-center">
      <div class="content" style="background-color: yellow;"> 
        <div class="row justify-content-center"> --}}
          <h1 style="font-family: serif; font-size: 30pt; font-size-adjust: 1.2 d-no d-md-block ; text-decoration: underline; font-weight: bolder;">Actualizar Plato Especial</h1>
        {{-- </div>    
      </div>
    </div> --}}
   </div>
      ...
      <div class="card-body ">
        <form class="was-validated " action="{{route('especiales.update',$plato->id)}}" class="form-control" method="post" enctype="multipart/form-data">
          @csrf
          {{method_field('PUT')}}
          <div class="row justify-content-center" >
            <div class="col-sm-6">
          ...
          <div class="row justify-content-center">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control custom-select"name="txtDescripcion" rows="3" placeholder="Enter ..."  required>{{$plato->descripcion}}</textarea>
                <div class="valid-feedback">
                  Campo obligatorio
                </div>
              </div>
