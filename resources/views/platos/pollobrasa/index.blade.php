    ...
    {{-- <div id="separator-ribbon" class="justify-content-center">
      <div class="content" style="background-color: yellow;"> 
        <div class="row justify-content-center"> --}}
          <h1 style="font-family: serif; font-size: 30pt; font-size-adjust: 1.2 d-no d-md-block ; text-decoration: underline; font-weight: bolder;">Platos de Pollo a la Brasa</h1>
        {{-- </div>    
      </div>
    </div> --}}
   </div>
   
    <form action="{{route('polloBrasa.create')}}">
      <div class="row">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Platos de Pollo a la Brasa</h3>             
            </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col col-sm-5">
                      <form action="{{route('polloBrasa.destroy', $item->id)}}" method="POST">
                        @csrf
                        {{method_field('DELETE')}} 
                   ...
                   <div class="col col-sm-6">
                    <form action="{{route('polloBrasa.edit',$item->id)}}" method="get">
